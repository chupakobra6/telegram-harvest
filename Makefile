...
help:
	...
	@printf "  make transcribe-file PROFILE=main # local production ASR; INPUT=... OUTPUT=... ASSUME_SPEECH=1\\n"
...
transcribe-file:
	...
	$(CLI) $(PROFILE_ARG) transcribe-file --input "$(INPUT)" --output "$(OUTPUT)" $(if $(strip $(ASSUME_SPEECH)),--assume-speech,)
