...
func TestPruneDailyStateKeepsRetentionWindow(t *testing.T) {
	...
	writeRetentionFile(t, filepath.Join(root, "jsonl", "2026-05-20.jsonl"), "old")
	writeRetentionFile(t, filepath.Join(root, "jsonl", "2026-06-01.jsonl"), "new")
	reportRoot := DailyDefaultReportRoot(root)
	writeRetentionFile(t, filepath.Join(reportRoot, "2026-05-20.md"), "old")
	writeRetentionFile(t, filepath.Join(reportRoot, "2026-06-01.md"), "new")
	...
	assertMissing(t, filepath.Join(root, "jsonl", "2026-05-20.jsonl"))
	assertExists(t, filepath.Join(root, "jsonl", "2026-06-01.jsonl"))
	assertMissing(t, filepath.Join(reportRoot, "2026-05-20.md"))
	assertExists(t, filepath.Join(reportRoot, "2026-06-01.md"))
